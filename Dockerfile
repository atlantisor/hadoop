...
# clear the tmp folder as the fresh hdfs data folder
RUN rm -rf /tmp/*
...
#expose ports    
EXPOSE 50020 50021 50090 50070 50010 50011 50075 50076 8031 8032 8033 8040 8042 49707 22 8088 8030 8020 13562
